...
spl-core = { git = "https://github.com/solpbc/spl-rust", rev = "44d17b0e02fd9937449dcebec5fd43aad827bd7f" }
spl-transport = { git = "https://github.com/solpbc/spl-rust", rev = "44d17b0e02fd9937449dcebec5fd43aad827bd7f" }
EOF
  cat <<'EOF' > "$TEST_ROOT/Cargo.lock"
[[package]]
name = "spl-core"
version = "0.1.0"
source = "git+https://github.com/solpbc/spl-rust?rev=44d17b0e02fd9937449dcebec5fd43aad827bd7f#44d17b0e02fd9937449dcebec5fd43aad827bd7f"
