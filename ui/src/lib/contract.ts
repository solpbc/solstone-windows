...
export const automationContract = {
  ...
  "automation_ids": {
    ...
    "settings.unknown-journal.detail": "settings.unknown-journal.detail",
    "settings.unknown-journal.list": "settings.unknown-journal.list",
    "settings.unknown-journal.responding-caption": "settings.unknown-journal.responding-caption",
    "settings.unknown-journal.summary": "settings.unknown-journal.summary",
    "settings.unknown-journal.what-answered": "settings.unknown-journal.what-answered",
    "settings.unknown-journal.your-journal": "settings.unknown-journal.your-journal",
